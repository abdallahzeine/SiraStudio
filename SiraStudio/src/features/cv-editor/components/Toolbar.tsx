...
import { Link2, Plus, Printer, RotateCcw, Save, Unlink2, Zap } from 'lucide-react';
  ...
  return (
    <>
      ...
      <button onClick={onOpenAI}
        className="toolbar-btn flex h-10 shrink-0 items-center gap-1.5 rounded-xl bg-[#0078D7] px-3 text-sm text-white shadow-sm transition-colors hover:bg-blue-700">
        <Zap size={14} />
        <span className="hidden @[760px]:inline">AI Assistant</span>
      </button>
